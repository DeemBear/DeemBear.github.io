...
//修改
		mdOption.innerHTML += `<div class="optionItems" style="width:${optionWidth}px;left:-${optionWidth - 10}px">`
				...
				</div>` : `<div data-id="editMd" class="optionItem" title="${translations[locale]["edit"]}">
				<svg width="18" height="18"><use xlink:href="#chatEditIcon" /></svg>
...
const initSetting = () => {
		...
		modelVersion = modelEle.value = localModel || "gpt-3.5-turbo-16k";
		modelEle.onchange = () => {
		...
		userAvatar = setAvatarPre.src = setAvatar.value = localAvatar || setAvatar.getAttribute("value") || "favicon.ico";//修改
		setAvatar.onchange = () => {
