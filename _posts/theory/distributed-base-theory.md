...
![img](distributed-base-theory.assets/20200202201007.png)
...
![img](distributed-base-theory.assets/%E5%88%86%E5%B8%83%E5%BC%8F%E7%90%86%E8%AE%BA-CAP.jpg)
...
![img](distributed-base-theory.assets/bg2018071601.png)
...
![img](distributed-base-theory.assets/bg2018071602.png)

接下来，用户的读操作就会得到 v1。这就叫一致性。

![img](distributed-base-theory.assets/bg2018071603.png)

问题是，用户有可能向 G2 发起读操作，由于 G2 的值没有发生变化，因此返回的是 v0。G1 和 G2 读操作的结果不一致，这就不满足一致性了。

![img](distributed-base-theory.assets/bg2018071604.png)

为了让 G2 也能变为 v1，就要在 G1 写操作的时候，让 G1 向 G2 发送一条消息，要求 G2 也改成 v1。

![img](distributed-base-theory.assets/bg2018071605.png)

这样的话，用户向 G2 发起读操作，也能得到 v1。

![img](distributed-base-theory.assets/bg2018071606.png)
...
![img](distributed-base-theory.assets/%E5%88%86%E5%B8%83%E5%BC%8F%E7%90%86%E8%AE%BA-BASE.png)
