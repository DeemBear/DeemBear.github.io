...
![img](distributed-transaction.assets/%E6%95%B0%E6%8D%AE%E5%BA%93%E4%BA%8B%E5%8A%A1.png)
...
![img](distributed-transaction.assets/20200205112615.png)

上图中包含了库存和订单两个独立的微服务，每个微服务维护了自己的数据库。在交易系统的业务逻辑中，一个商品在下单之前需要先调用库存服务，进行扣除库存，再调用订单服务，创建订单记录。

![img](distributed-transaction.assets/20200205112518.png)
...
![img](distributed-transaction.assets/20200205154145.png)
...
![img](distributed-transaction.assets/20200205180242.png)
...
![img](distributed-transaction.assets/20200205205117.png)
...
![img](distributed-transaction.assets/20200205180425.png)
...
![img](distributed-transaction.assets/20200205180515.png)
...
![img](distributed-transaction.assets/20200205205200.png)
...
![img](distributed-transaction.assets/20200205205221.png)
...
![img](distributed-transaction.assets/20200205220246.png)
...
![img](distributed-transaction.assets/20200205230320.png)
...
![img](distributed-transaction.assets/20200205230412.png)
...
![Saga事务执行顺序](distributed-transaction.assets/1679817d8ce9b4b7)
...
![Saga事务向前恢复](distributed-transaction.assets/1679817da631d59c)

对应于上面第一种执行顺序，适用于必须要成功的场景，发生失败进行重试，执行顺序是类似于这样的：T1, T2, ..., Tj(失败), Tj(重试),..., Tn，其中 j 是发生错误的子事务(sub-transaction)。该情况下不需要 Ci。

- 向后恢复(backward recovery)

![Saga事务向后恢复](distributed-transaction.assets/1679817da706b3c2)
...
![命令协调模式](distributed-transaction.assets/1679817daa1798dd)
...
![事件编排模式](distributed-transaction.assets/1679817dba9b2b61)
...
![方案比较](distributed-transaction.assets/1679817dc68ae74d)
