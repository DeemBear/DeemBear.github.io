---
layout: post
date: 2020-05-13 13:37:00
title: 如何搭建一个直播平台？
description: "介绍了一些直播平台的相关技术"
categories: 善事
tags: 转载
---

直播：可以从PC或手机 **直播**，然后从PC或是手机或是支持HTML5的浏览器 **收看**。

利用AirPlay和Chromecast协议，能够截获和播放任何手机（iOS或是Android）屏幕上的任何内容。

比如，通过屏幕直播，可以邀请朋友看你正在看的直播的电影，球赛，演唱会，晚会，不管是免费的还是付费的。

将屏幕的内容，通过AirPlay或Chromecast，推送到后台服务器，然后，受邀的朋友就可以从浏览器或是其它视频播放器观看。

这种直播平台技术，除了“微光”还有“雨见浏览器”实现了。
...
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-01.webp)

另一个是由客户端向服务器发起请求从服务器端接受数据，可以多次调用，这就是播放服务。流程如下。
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-02.jpg)
...
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-03.webp)

m3u8 playlist的文件结构，它不是一个单独的文件，而是由一系列文件组成。Index文件和很多的数据文件。
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-04.webp)

一个m3u8 playlist的index文件内容。
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-05.webp)

所有的数据文件，以.ts为后缀，存放在同一目录下面。
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-06.webp)
...
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-07.webp)
...
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-08.webp)

OBS能够讲视频流推送到支持RTMP协议的服务器上，需要进行一些简单的设置。服务器的地址，和流的密钥，这样，可以区分不同的用户，也保证了不同用户的内容安全。
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-09.webp)
...
源代码文件目录。
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-10.webp)

注册界面。
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-11.webp)

播放和评论界面。
![](https://raw.githubusercontent.com/DeemBear/DeemBear.github.io/master/_posts/转载/2020-05-13-g-01-12.webp)
